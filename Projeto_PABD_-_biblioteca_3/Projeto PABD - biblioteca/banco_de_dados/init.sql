...
CREATE TABLE IF NOT EXISTS emprestimos (
    ...
    data_devolucao       DATE NOT NULL,  -- prazo (data prevista de devolução)
    data_devolucao_real  DATE NULL,      -- preenchida só quando o livro é devolvido de fato
...
-- que o bolsista aprova (vira empréstimo de verdade) ou rejeita.
CREATE TABLE IF NOT EXISTS solicitacoes_emprestimo (
    id                INT AUTO_INCREMENT PRIMARY KEY,
    id_usuario        INT NOT NULL,
    id_livro          INT NOT NULL,  -- referencia exemplares.id
